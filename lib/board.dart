            ...
            children: [
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Flexible(
                      flex: 2,
                      child: HorizontalBarrier(isOccupied: checkBit(5))),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: HorizontalBarrier(isOccupied: checkBit(6))),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: HorizontalBarrier(isOccupied: checkBit(7))),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: HorizontalBarrier(isOccupied: checkBit(8))),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: HorizontalBarrier(isOccupied: checkBit(9))),
                  const Spacer(),
                  Flexible(
                      flex: 2,
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(11))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(12))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(13))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(14))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(15))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                ],
              ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(22))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(23))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(24))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(25))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(26))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                ],
              ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(33))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(34))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(35))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(36))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(37))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                ],
              ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(44))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(45))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(46))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(47))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(48))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                ],
              ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(55))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(56))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(57))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(58))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                  const Spacer(),
                  Flexible(
                      flex: 2,
                      child: VerticalBarrier(isOccupied: checkBit(59))),
                  const Spacer(),
                  const Flexible(flex: 12, child: Cell()),
                ],
              ),
